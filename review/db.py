...
class DBObject(object):
    ...
    def dirty(cls, ids):
        ...
        review.cache.delete_multi(ids, key_prefix=cls._cache_key())
    ...
    def get(cls, ids, one=False):
        ...
        values = review.cache.get_multi(ids, key_prefix=key_prefix)
        ...
        review.cache.set_multi(cache_mapping, key_prefix=key_prefix, timeout=cls.__timeout__)
